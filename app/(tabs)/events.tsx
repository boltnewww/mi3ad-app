...
import { Search, SlidersHorizontal, MapPin, Calendar, Users } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {/* Category Filter */}
        <Animated.ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categoryFilter}>
